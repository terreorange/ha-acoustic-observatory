...
Foundation only. The add-on skeleton is included so the repository layout is ready, but it still needs validation on Home Assistant OS before being considered installable.
